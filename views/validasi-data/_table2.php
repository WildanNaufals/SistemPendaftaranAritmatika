 ...
 * @Last Modified time: 2017-07-06 08:52:31
 */
            ...
            [
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span class="fa fa-check"></span> Validasi', $url, [
                                    'class' => 'btn btn-success btn-xs', 'data-toggle' => 'tooltip',  'title' => 'Validasi ' . $model->nama,
                        ]);
                    },
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    ...
                    if ($action === 'update') {
                        $url = ['validasi', 'a' => $model->id, 'b' => $model->auth_key];
                        return $url;
                    }
                    if ($action === 'delete') {
