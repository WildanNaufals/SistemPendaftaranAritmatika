 ...
 * @Last Modified time: 2017-06-21 05:11:24
 */
...
$this->title = 'Perbarui Data: ' . $model->no_peserta;
...
<div class="square">
    <h4 class="text-center">
        <i class="fa fa-id-card"></i> FORM PERUBAHAN PENDAFTARAN OFFLINE ARITMATIKA 2017
    </h4>
    ...
    <?php
        $wizard_config = [
            ...
            'complete_content' => '
                ...
                Html::submitButton('Perbarui Data', ['class' => 'btn btn-primary btn-block'])
        ];
    ?>
