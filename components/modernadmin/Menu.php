...
namespace app\components\modernadmin;
...
/**
 * Class Menu for Template Modern Admin
 * Theme menu widget.
 */
class Menu extends \yii\widgets\Menu
{
    ...
    public $defaultIconHtml = '<span class="menu-icon icon-plane"></span>';

    /**
     * @var string
     */
    public static $iconClassPrefix = 'menu-icon icon-';
    ...
    protected function renderItem($item)
    {
        ...
        if (isset($item['url'])) {
            ...
            $replace = !empty($item['icon']) ? [
                ...
                '{icon}' => '<span class="' . self::$iconClassPrefix . $item['icon'] . '"></span>'
            ] : [
                '{url}' => Url::to($item['url']),
                '{label}' => '<p>'.$item['label'].'</p>',
